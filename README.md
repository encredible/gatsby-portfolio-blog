...
1.  **Create a Gatsby site.**
    ...
    ```shell
    # create a new Gatsby site using the blog-content starter
    gatsby new my-blog-content-starter https://github.com/gatsbyjs/gatsby-starter-blog
    ```
